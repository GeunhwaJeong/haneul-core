...
The `coin_type` value is managed with a repository of all other cryptocurrencies. Both signature schemes use Haneul's registered `coin_type`: `784`.
...
```sh
$ haneul keytool import "TEST_MNEMONIC" ed25519 "m/44'/784'/0'/0'/0'"
```
```sh
$ haneul client new-address ed25519 "m/44'/784'/0'/0'/0'"
```
