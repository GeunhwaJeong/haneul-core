...
- [x] Complete all [Haneul installation prerequisites](/guides/developer/getting-started/haneul-install.mdx).
...
This creates a stake object (of type `0x3::staking_pool::StakedHaneul`). This object can be withdrawn with the following command:
