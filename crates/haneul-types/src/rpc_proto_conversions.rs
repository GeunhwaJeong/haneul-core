...
impl Merge<crate::messages_checkpoint::CheckpointSummary> for CheckpointSummary {
    fn merge(
        ...
        if mask.contains(Self::TIMESTAMP_FIELD) {
            self.timestamp = Some(haneul_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
        }
...
impl From<crate::haneul_system_state::HaneulSystemState> for SystemState {
    fn from(value: crate::haneul_system_state::HaneulSystemState) -> Self {
        match value {
            crate::haneul_system_state::HaneulSystemState::V1(v1) => v1.into(),
            crate::haneul_system_state::HaneulSystemState::V2(v2) => v2.into(),
...
impl From<crate::haneul_system_state::haneul_system_state_inner_v1::HaneulSystemStateInnerV1>
    for SystemState
{
    fn from(
        crate::haneul_system_state::haneul_system_state_inner_v1::HaneulSystemStateInnerV1 {
            epoch,
            protocol_version,
...
impl From<crate::haneul_system_state::haneul_system_state_inner_v2::HaneulSystemStateInnerV2>
    for SystemState
{
    fn from(
        crate::haneul_system_state::haneul_system_state_inner_v2::HaneulSystemStateInnerV2 {
            epoch,
            protocol_version,
            system_state_version,
            validators,
...
impl From<crate::haneul_system_state::haneul_system_state_inner_v1::SystemParametersV1>
    for SystemParameters
{
    fn from(
        crate::haneul_system_state::haneul_system_state_inner_v1::SystemParametersV1 {
            epoch_duration_ms,
...
impl From<crate::haneul_system_state::haneul_system_state_inner_v2::SystemParametersV2>
    for SystemParameters
{
    fn from(
        crate::haneul_system_state::haneul_system_state_inner_v2::SystemParametersV2 {
            epoch_duration_ms,
            stake_subsidy_start_epoch,
            min_validator_count,
            max_validator_count,
...
impl From<crate::haneul_system_state::haneul_system_state_inner_v1::StorageFundV1> for StorageFund {
    fn from(
        crate::haneul_system_state::haneul_system_state_inner_v1::StorageFundV1 {
...
impl From<crate::haneul_system_state::haneul_system_state_inner_v1::StakingPoolV1> for StakingPool {
    fn from(
        crate::haneul_system_state::haneul_system_state_inner_v1::StakingPoolV1 {
            id,
            activation_epoch,
            deactivation_epoch,
            haneul_balance,
        ...
        message.haneul_balance = Some(haneul_balance);
        ...
        message.pending_total_haneul_withdraw = Some(pending_total_haneul_withdraw);
...
impl From<crate::haneul_system_state::haneul_system_state_inner_v1::ValidatorV1> for Validator {
    fn from(
        crate::haneul_system_state::haneul_system_state_inner_v1::ValidatorV1 {
            metadata:
                crate::haneul_system_state::haneul_system_state_inner_v1::ValidatorMetadataV1 {
                    haneul_address,
        ...
        message.address = Some(haneul_address.to_string());
...
impl TryFrom<&SystemState>
    for crate::haneul_system_state::haneul_system_state_summary::HaneulSystemStateSummary
{
    type Error = TryFromProtoError;
...
impl TryFrom<&Validator>
    for crate::haneul_system_state::haneul_system_state_summary::HaneulValidatorSummary
{
    type Error = TryFromProtoError;
    ...
    for crate::crypto::AuthorityQuorumSignInfo<T>
{
    ...
    fn try_from(value: &ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            signers_map: crate::haneul_serde::deserialize_haneul_bitmap(value.bitmap())
...
impl From<&crate::zk_login_authenticator::ZkLoginAuthenticator> for ZkLoginAuthenticator {
    fn from(value: &crate::zk_login_authenticator::ZkLoginAuthenticator) -> Self {
        ...
        haneul_sdk_types::ZkLoginAuthenticator::try_from(value.clone())
            .map(Into::into)
            .ok()
            .unwrap_or(message)
    }
...
impl From<&crate::crypto::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
    fn from(value: &crate::crypto::ZkLoginPublicIdentifier) -> Self {
        //TODO implement this without going through the sdk type
        haneul_sdk_types::ZkLoginPublicIdentifier::try_from(value.to_owned())
            .map(|id| (&id).into())
            .ok()
            .unwrap_or_default()
    }
...
impl From<crate::transaction::ChangeEpoch> for ChangeEpoch {
    fn from(value: crate::transaction::ChangeEpoch) -> Self {
        ...
        message.epoch_start_timestamp = Some(haneul_rpc::proto::timestamp_ms_to_proto(
...
impl From<&crate::coin_registry::Currency> for CoinMetadata {
    fn from(value: &crate::coin_registry::Currency) -> Self {
        ...
        metadata.id = Some(haneul_sdk_types::Address::from(value.id.into_bytes()).to_string());
        ...
        match &value.metadata_cap_id {
            crate::coin_registry::MetadataCapState::Claimed(id) => {
                ...
                metadata.metadata_cap_id = Some(haneul_sdk_types::Address::from(*id).to_string());
            }
            crate::coin_registry::MetadataCapState::Unclaimed => {
...
impl From<crate::coin::CoinMetadata> for CoinMetadata {
    fn from(value: crate::coin::CoinMetadata) -> Self {
        let mut metadata = CoinMetadata::default();
        metadata.id = Some(haneul_sdk_types::Address::from(value.id.id.bytes).to_string());
        metadata.decimals = Some(value.decimals.into());
...
impl From<crate::coin::TreasuryCap> for CoinTreasury {
    fn from(value: crate::coin::TreasuryCap) -> Self {
        ...
        treasury.id = Some(haneul_sdk_types::Address::from(value.id.id.bytes).to_string());
    ...
    fn from(value: &crate::coin_registry::RegulatedState) -> Self {
        ...
        match value {
            crate::coin_registry::RegulatedState::Regulated {
                ...
                regulated.deny_cap_object = Some(haneul_sdk_types::Address::from(*cap).to_string());
...
impl From<crate::coin::RegulatedCoinMetadata> for RegulatedCoinMetadata {
    fn from(value: crate::coin::RegulatedCoinMetadata) -> Self {
        ...
        message.id = Some(haneul_sdk_types::Address::from(value.id.id.bytes).to_string());
        message.coin_metadata_object =
            Some(haneul_sdk_types::Address::from(value.coin_metadata_object.bytes).to_string());
        message.deny_cap_object =
            Some(haneul_sdk_types::Address::from(value.deny_cap_object.bytes).to_string());
