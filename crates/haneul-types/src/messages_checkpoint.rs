...
impl CheckpointArtifact {
    pub fn digest(&self) -> HaneulResult<Digest> {
        match self {
...
impl CheckpointArtifacts {
    ...
    pub fn add_artifact(&mut self, artifact: CheckpointArtifact) -> HaneulResult<()> {
        if self
            .artifacts
            .iter()
...
impl CheckpointSummary {
    ...
    pub fn checkpoint_artifacts_digest(&self) -> HaneulResult<&CheckpointArtifactsDigest> {
...
impl CertifiedCheckpointSummary {
    ...
    pub fn try_into_verified(self, committee: &Committee) -> HaneulResult<VerifiedCheckpoint> {
...
impl SignedCheckpointSummary {
    ...
    pub fn try_into_verified(
        self,
        committee: &Committee,
    ) -> HaneulResult<VerifiedEnvelope<CheckpointSummary, AuthoritySignInfo>> {
        self.verify_authority_signatures(committee)?;
