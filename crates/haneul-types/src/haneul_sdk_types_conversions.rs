...
//! Module for conversions between haneul-core types and haneul-sdk types
//!
...
use crate::crypto::HaneulSignature as _;
...
impl From<crate::base_types::HaneulAddress> for Address {
    fn from(value: crate::base_types::HaneulAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<Address> for crate::base_types::HaneulAddress {
...
impl From<crate::execution_status::ExecutionFailureStatus> for ExecutionError {
    fn from(value: crate::execution_status::ExecutionFailureStatus) -> Self {
        match value {
            ...
            crate::execution_status::ExecutionFailureStatus::HaneulMoveVerificationError => Self::HaneulMoveVerificationError,
            ...
            crate::execution_status::ExecutionFailureStatus::HaneulMoveVerificationTimedout => Self::HaneulMoveVerificationTimedout,
...
impl From<ExecutionError> for crate::execution_status::ExecutionFailureStatus {
    fn from(value: ExecutionError) -> Self {
        match value {
            ...
            ExecutionError::HaneulMoveVerificationError => Self::HaneulMoveVerificationError,
            ...
            ExecutionError::HaneulMoveVerificationTimedout => Self::HaneulMoveVerificationTimedout,
            ...
            crate::crypto::Signature::Secp256k1HaneulSignature(secp256k1_haneul_signature) => {
                Self::Secp256k1 {
                    signature: Secp256k1Signature::from_bytes(
                        secp256k1_haneul_signature.signature_bytes(),
                    )?,
                    public_key: Secp256k1PublicKey::from_bytes(
                        secp256k1_haneul_signature.public_key_bytes(),
                    )?,
                }
            }

            crate::crypto::Signature::Secp256r1HaneulSignature(secp256r1_haneul_signature) => {
                Self::Secp256r1 {
                    signature: Secp256r1Signature::from_bytes(
                        secp256r1_haneul_signature.signature_bytes(),
                    )?,
                    public_key: Secp256r1PublicKey::from_bytes(
                        secp256r1_haneul_signature.public_key_bytes(),
                    )?,
                }
            }
        }
