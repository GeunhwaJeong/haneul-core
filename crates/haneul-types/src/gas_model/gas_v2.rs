...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, GasUsageReport, HaneulGasStatusAPI};
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in Haneul) for in this object.
        /// This is computed at the end of execution while determining storage charges.
        /// The value is in Haneul.
    ...
    impl HaneulGasStatus {
        ...
        pub(crate) fn new_with_budget(
            ...
            let haneul_cost_table = HaneulCostTable::new(config, gas_price);
            ...
            Self::new(
                GasStatus::new(
                    haneul_cost_table.execution_cost_table.clone(),
                    computation_budget,
                    gas_price,
        ...
        pub fn new_unmetered() -> HaneulGasStatus {
            Self::new(
