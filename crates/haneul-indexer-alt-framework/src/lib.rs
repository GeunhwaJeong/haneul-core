...
use haneul_indexer_alt_framework_store_traits::TransactionalStore;
...
pub use haneul_futures::service;
/// External users access the store trait through framework::store
pub use haneul_indexer_alt_framework_store_traits as store;
...
mod tests {
    ...
    use haneul_synthetic_ingestion::synthetic_ingestion;
    ...
    impl Processor for ControllableHandler {
        ...
        async fn process(
            &self,
            checkpoint: &Arc<haneul_types::full_checkpoint_content::Checkpoint>,
