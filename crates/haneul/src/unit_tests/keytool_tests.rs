...
async fn test_private_keys_import_export() -> Result<(), anyhow::Error> {
    ...
    const TEST_CASES: &[(&str, &str, &str, &str)] = &[
        (
            "haneulprivkey1qzwant3kaegmjy4qxex93s0jzvemekkjmyv3r2sjwgnv2y479pgsywhveae",
        ...
        (
            "haneulprivkey1qrh2sjl88rze74hwjndw3l26dqyz63tea5u9frtwcsqhmfk9vxdlx8cpv0g",
        ...
        (
            "haneulprivkey1qzg73qyvfz0wpnyectkl08nrhe4pgnu0vqx8gydu96qx7uj4wyr8gcrjlh3",
...
async fn test_mnemonics_ed25519() -> Result<(), anyhow::Error> {
    ...
    const TEST_CASES: [[&str; 3]; 3] = [
        [
            ...
            "haneulprivkey1qrwsjvr6gwaxmsvxk4cfun99ra8uwxg3c9pl0nhle7xxpe4s80y05ctazer",
            "a2d14fad60c56049ecf75246a481934691214ce413e6a8ae2fe6834c173a6133",
        ],
        [
            "require decline left thought grid priority false tiny gasp angle royal system attack beef setup reward aunt skill wasp tray vital bounce inflict level",
            "haneulprivkey1qzdvpa77ct272ultqcy20dkw78dysnfyg90fhcxkdm60el0qht9mvzlsh4j",
            "1ada6e6f3f3e4055096f606c746690f1108fcc2ca479055cc434a3e1d3f758aa",
        ],
        [
            "organ crash swim stick traffic remember army arctic mesh slice swear summer police vast chaos cradle squirrel hood useless evidence pet hub soap lake",
            "haneulprivkey1qqqscjyyr64jea849dfv9cukurqj2swx0m3rr4hr7sw955jy07tzgcde5ut",
...
async fn test_mnemonics_secp256k1() -> Result<(), anyhow::Error> {
    ...
    const TEST_CASES: [[&str; 3]; 3] = [
        [
            "film crazy soon outside stand loop subway crumble thrive popular green nuclear struggle pistol arm wife phrase warfare march wheat nephew ask sunny firm",
            "haneulprivkey1qyqr6yvxdqkh32ep4pk9caqvphmk9epn6rhkczcrhaeermsyvwsg783y9am",
            "9e8f732575cc5386f8df3c784cd3ed1b53ce538da79926b2ad54dcc1197d2532",
        ],
        [
            "require decline left thought grid priority false tiny gasp angle royal system attack beef setup reward aunt skill wasp tray vital bounce inflict level",
            "haneulprivkey1q8hexn5m2u36tx39ln5e22hfseadknp7d2qlkhe30ejy7fc6am5aqkqpqsj",
            "9fd5a804ed6b46d36949ff7434247f0fd594673973ece24aede6b86a7b5dae01",
        ],
        [
            "organ crash swim stick traffic remember army arctic mesh slice swear summer police vast chaos cradle squirrel hood useless evidence pet hub soap lake",
            "haneulprivkey1qxx6yf53jgxvsmccst8cuwnj0rx4k4uzvn9aalvag7ns0xf0g8j2x246jst",
...
async fn test_mnemonics_secp256r1() -> Result<(), anyhow::Error> {
    ...
    const TEST_CASES: [[&str; 3]; 3] = [
        [
            ...
            "haneulprivkey1qgj6vet4rstf2p00j860xctkg4fyqqq5hxgu4mm0eg60fq787ujnqs5wc8q",
        ...
        [
            ...
            "haneulprivkey1qgmgr6dza8slgxn0rcxcy47xeas9l565cc5q440ngdzr575rc2356gzlq7a",
        ...
        [
            ...
            "haneulprivkey1qt2gsye4dyn0lxey0ht6d5f2ada7ew9044a49y2f3mymy2uf0hr55jmfze3",
...
async fn test_invalid_derivation_path() -> Result<(), anyhow::Error> {
    ...
    assert!(
        KeyToolCommand::Import {
            ...
            input_string: TEST_MNEMONIC.to_string(),
            key_scheme: SignatureScheme::ED25519,
            derivation_path: Some("m/0'/8282'/0'/0/0".parse().unwrap()),
        }
        .execute(&mut context)
        .await
        .is_err()
