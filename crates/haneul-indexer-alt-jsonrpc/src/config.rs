...
pub struct RpcConfig {
    ...
    /// Configuration for HaneulNS related RPC methods.
    ...
    pub package_resolver: haneul_package_resolver::Limits,
}
...
impl PackageResolverLayer {
    pub fn finish(self) -> haneul_package_resolver::Limits {
...
impl Default for NodeConfig {
    fn default() -> Self {
        Self {
            header_value: "haneul-indexer-alt-jsonrpc".to_string(),
