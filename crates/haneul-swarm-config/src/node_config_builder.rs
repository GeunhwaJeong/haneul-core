...
impl ValidatorConfigBuilder {
    ...
    pub fn build(
        ...
        genesis: haneul_config::genesis::Genesis,
    ) -> NodeConfig {
        ...
        NodeConfig {
            ...
            genesis: haneul_config::node::Genesis::new(genesis),
            grpc_load_shed: None,
            ...
            rpc: Some(haneul_rpc_api::Config {
                ..Default::default()
            }),
...
impl FullnodeConfigBuilder {
    ...
    pub fn with_rpc_config(mut self, rpc_config: haneul_config::RpcConfig) -> Self {
    ...
    pub fn build<R: rand::RngCore + rand::CryptoRng>(
        ...
        NodeConfig {
            ...
            network_key_pair: self.network_key_pair.unwrap_or(KeyPairWithPath::new(
                HaneulKeyPair::Ed25519(validator_config.network_key_pair),
            )),
            db_path: self
                .db_path
            ...
            genesis: self.genesis.unwrap_or(haneul_config::node::Genesis::new(
