...
use haneul_config::{ExecutionCacheConfig, NodeConfig};
...
/// A handle to an in-memory Haneul Network.
#[derive(Debug)]
pub struct Swarm {
    dir: SwarmDirectory,
...
impl Swarm {
    ...
    pub async fn spawn_new_node(&mut self, config: NodeConfig) -> HaneulNodeHandle {
