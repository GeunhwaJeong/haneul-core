...
pub struct QuorumTransactionResponse {
    pub effects: haneul_types::transaction_driver_types::FinalizedEffects,

    pub events: Option<haneul_types::effects::TransactionEvents>,
    // Input objects will only be populated in the happy path
    pub input_objects: Option<Vec<haneul_types::object::Object>>,
    // Output objects will only be populated in the happy path
    pub output_objects: Option<Vec<haneul_types::object::Object>>,
