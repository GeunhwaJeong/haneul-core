...
pub struct TransactionDenyConfig {
    ...
    /// A list of haneul addresses that are not allowed to be used as the sender or sponsor.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    address_deny_list: Vec<HaneulAddress>,
    ...
    #[serde(skip)]
    address_deny_set: OnceCell<HashSet<HaneulAddress>>,
...
impl TransactionDenyConfig {
    ...
    pub fn get_address_deny_set(&self) -> &HashSet<HaneulAddress> {
...
impl TransactionDenyConfigBuilder {
    ...
    pub fn add_denied_address(mut self, address: HaneulAddress) -> Self {
