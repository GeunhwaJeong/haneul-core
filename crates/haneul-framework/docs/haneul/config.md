...
-  [Macro function `entry`](#haneul_config_entry)
-  [Macro function `update`](#haneul_config_update)
...
<pre><code><b>public</b> <b>struct</b> <a href="../haneul/config.md#haneul_config_Config">Config</a>&lt;<b>phantom</b> WriteCap&gt; <b>has</b> key
</code></pre>
...
<pre><code><b>public</b> <b>struct</b> <a href="../haneul/config.md#haneul_config_Setting">Setting</a>&lt;Value: <b>copy</b>, drop, store&gt; <b>has</b> drop, store
</code></pre>
...
<pre><code><b>public</b> <b>struct</b> <a href="../haneul/config.md#haneul_config_SettingData">SettingData</a>&lt;Value: <b>copy</b>, drop, store&gt; <b>has</b> drop, store
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/config.md#haneul_config_new">new</a>&lt;WriteCap&gt;(_cap: &<b>mut</b> WriteCap, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;WriteCap&gt;
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/config.md#haneul_config_share">share</a>&lt;WriteCap&gt;(<a href="../haneul/config.md#haneul_config">config</a>: <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;WriteCap&gt;)
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/transfer.md#haneul_transfer">transfer</a>&lt;WriteCap&gt;(<a href="../haneul/config.md#haneul_config">config</a>: <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;WriteCap&gt;, owner: <b>address</b>)
</code></pre>
...
&gt;(
    ...
    <b>if</b> (!field::exists_(&<a href="../haneul/config.md#haneul_config">config</a>.id, name)) {
        ...
        sobj
            .data
            .fill(<a href="../haneul/config.md#haneul_config_SettingData">SettingData</a> {
                newer_value_epoch: epoch,
                newer_value: option::some(value),
                older_value_opt,
            });
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/config.md#haneul_config_remove_for_next_epoch">remove_for_next_epoch</a>&lt;WriteCap, Name: <b>copy</b>, drop, store, Value: <b>copy</b>, drop, store&gt;(<a href="../haneul/config.md#haneul_config">config</a>: &<b>mut</b> <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;WriteCap&gt;, _cap: &<b>mut</b> WriteCap, name: Name, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;Value&gt;
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/config.md#haneul_config_exists_with_type">exists_with_type</a>&lt;WriteCap, Name: <b>copy</b>, drop, store, Value: <b>copy</b>, drop, store&gt;(<a href="../haneul/config.md#haneul_config">config</a>: &<a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;WriteCap&gt;, name: Name): bool
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/config.md#haneul_config_exists_with_type_for_next_epoch">exists_with_type_for_next_epoch</a>&lt;WriteCap, Name: <b>copy</b>, drop, store, Value: <b>copy</b>, drop, store&gt;(<a href="../haneul/config.md#haneul_config">config</a>: &<a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;WriteCap&gt;, name: Name, ctx: &<a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): bool
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/config.md#haneul_config_read_setting_for_next_epoch">read_setting_for_next_epoch</a>&lt;WriteCap, Name: <b>copy</b>, drop, store, Value: <b>copy</b>, drop, store&gt;(<a href="../haneul/config.md#haneul_config">config</a>: &<a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;WriteCap&gt;, name: Name): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;Value&gt;
</code></pre>
...
<a name="haneul_config_entry"></a>

## Macro function `entry`



<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>macro</b> <b>fun</b> <b>entry</b>&lt;$WriteCap, $Name: <b>copy</b>, drop, store, $Value: <b>copy</b>, drop, store&gt;($<a href="../haneul/config.md#haneul_config">config</a>: &<b>mut</b> <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;$WriteCap&gt;, $cap: &<b>mut</b> $WriteCap, $name: $Name, $initial_for_next_epoch: |&<b>mut</b> <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;$WriteCap&gt;, &<b>mut</b> $WriteCap, &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>| -&gt; $Value, $ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): &<b>mut</b> $Value
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>macro</b> <b>fun</b> <b>entry</b>&lt;$WriteCap, $Name: <b>copy</b> + drop + store, $Value: <b>copy</b> + drop + store&gt;(
    $<a href="../haneul/config.md#haneul_config">config</a>: &<b>mut</b> <a href="../haneul/config.md#haneul_config_Config">Config</a>&lt;$WriteCap&gt;,
    $cap: &<b>mut</b> $WriteCap,
    $name: $Name,
    $initial_for_next_epoch: |&<b>mut</b> <a href="../haneul/config.md#haneul_config_Config">Config</a>&lt;$WriteCap&gt;, &<b>mut</b> $WriteCap, &<b>mut</b> TxContext| -&gt; $Value,
    $ctx: &<b>mut</b> TxContext,
): &<b>mut</b> $Value {
    <b>let</b> <a href="../haneul/config.md#haneul_config">config</a> = $<a href="../haneul/config.md#haneul_config">config</a>;
    <b>let</b> cap = $cap;
    <b>let</b> name = $name;
    <b>let</b> ctx = $ctx;
    <b>if</b> (!<a href="../haneul/config.md#haneul_config">config</a>.<a href="../haneul/config.md#haneul_config_exists_with_type_for_next_epoch">exists_with_type_for_next_epoch</a>&lt;_, _, $Value&gt;(name, ctx)) {
        <b>let</b> initial = $initial_for_next_epoch(<a href="../haneul/config.md#haneul_config">config</a>, cap, ctx);
        <a href="../haneul/config.md#haneul_config">config</a>.<a href="../haneul/config.md#haneul_config_add_for_next_epoch">add_for_next_epoch</a>(cap, name, initial, ctx);
    };
    <a href="../haneul/config.md#haneul_config">config</a>.<a href="../haneul/config.md#haneul_config_borrow_for_next_epoch_mut">borrow_for_next_epoch_mut</a>(cap, name, ctx)
}
</code></pre>
...
<a name="haneul_config_update"></a>

## Macro function `update`



<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>macro</b> <b>fun</b> <a href="../haneul/config.md#haneul_config_update">update</a>&lt;$WriteCap, $Name: <b>copy</b>, drop, store, $Value: <b>copy</b>, drop, store&gt;($<a href="../haneul/config.md#haneul_config">config</a>: &<b>mut</b> <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;$WriteCap&gt;, $cap: &<b>mut</b> $WriteCap, $name: $Name, $initial_for_next_epoch: |&<b>mut</b> <a href="../haneul/config.md#haneul_config_Config">haneul::config::Config</a>&lt;$WriteCap&gt;, &<b>mut</b> $WriteCap, &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>| -&gt; $Value, $update_for_next_epoch: |<a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;$Value&gt;, &<b>mut</b> $Value| -&gt; (), $ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>macro</b> <b>fun</b> <a href="../haneul/config.md#haneul_config_update">update</a>&lt;
    $WriteCap,
    $Name: <b>copy</b> + drop + store,
    $Value: <b>copy</b> + drop + store,
&gt;(
    ...
    <b>let</b> name = $name;
    <b>let</b> ctx = $ctx;
    <b>let</b> old_value_opt = <b>if</b> (!<a href="../haneul/config.md#haneul_config">config</a>.<a href="../haneul/config.md#haneul_config_exists_with_type_for_next_epoch">exists_with_type_for_next_epoch</a>&lt;_, _, $Value&gt;(name, ctx)) {
        <b>let</b> initial = $initial_for_next_epoch(<a href="../haneul/config.md#haneul_config">config</a>, cap, ctx);
        <a href="../haneul/config.md#haneul_config">config</a>.<a href="../haneul/config.md#haneul_config_add_for_next_epoch">add_for_next_epoch</a>(cap, name, initial, ctx)
    } <b>else</b> {
        option::none()
    };
    $update_for_next_epoch(old_value_opt, <a href="../haneul/config.md#haneul_config">config</a>.<a href="../haneul/config.md#haneul_config_borrow_for_next_epoch_mut">borrow_for_next_epoch_mut</a>(cap, name, ctx));
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../haneul/config.md#haneul_config_read_setting_impl">read_setting_impl</a>&lt;FieldSettingValue: key, SettingValue: store, SettingDataValue: store, Value: <b>copy</b>, drop, store&gt;(<a href="../haneul/config.md#haneul_config">config</a>: <b>address</b>, name: <b>address</b>, current_epoch: u64): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;Value&gt;
</code></pre>
