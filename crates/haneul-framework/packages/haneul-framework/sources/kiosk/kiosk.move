...
/// `list_with_purchase_cap` therefore performing a trade (ishaneulng a
...
entry fun default(ctx: &mut TxContext) {
    ...
    haneul::transfer::share_object(kiosk);
}
...
public fun close_and_withdraw(self: Kiosk, cap: KioskOwnerCap, ctx: &mut TxContext): Coin<HANEUL> {
