...
impl TryConstructTransaction for Stake {
    async fn try_fetch_needed_objects(
        ...
        // Staking needs enough HANEUL to cover both the stake amount and gas. We select up to 1500
        ...
        // [8, 6, 4] HANEUL coins and wanting to stake 10 + gas, no discrete set works - we must
        ...
        let simulation_amount = amount.unwrap_or(1_000_000_000); // 1 HANEUL minimum staking threshold
