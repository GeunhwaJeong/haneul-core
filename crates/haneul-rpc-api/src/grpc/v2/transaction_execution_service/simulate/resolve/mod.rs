...
pub fn resolve_transaction(
    ...
    let commands = ptb
        .commands
        .iter()
        .map(haneul_sdk_types::Command::try_from)
...
fn resolve_unresolved_transaction(
    ...
    reference_gas_price: u64,
    max_gas_budget: u64,
    sender: haneul_sdk_types::Address,
    unresolved_inputs: &[haneul_rpc::proto::haneul::rpc::v2::Input],
    commands: Vec<Command>,
    gas_payment: Option<&haneul_rpc::proto::haneul::rpc::v2::GasPayment>,
    expiration: Option<&haneul_rpc::proto::haneul::rpc::v2::TransactionExpiration>,
) -> Result<TransactionData> {
    ...
    let expiration = expiration
        .map(haneul_types::transaction::TransactionExpiration::try_from)
        .transpose()
        .map_err(|e| {
        ...
        .unwrap_or(haneul_types::transaction::TransactionExpiration::None);
...
fn resolve_gas_object_reference(
    ...
    let Ok(gas_coin) = haneul_types::gas_coin::GasCoin::try_from(&object) else {
...
fn resolve_arg(
    ...
    called_packages: &mut NormalizedPackages,
    commands: &[Command],
    arg: &haneul_rpc::proto::haneul::rpc::v2::Input,
    arg_idx: usize,
) -> Result<CallArg> {
...
fn resolve_shared_input_with_object(
    ...
    Ok(ObjectArg::SharedObject {
        ...
        mutability: if mutable {
            ...
            haneul_types::transaction::SharedObjectMutability::Immutable
        },
    })
}
...
impl TryFrom<&haneul_rpc::proto::haneul::rpc::v2::ObjectReference> for UnresolvedObjectReference {
    type Error = FieldViolation;

    fn try_from(
        value: &haneul_rpc::proto::haneul::rpc::v2::ObjectReference,
...
struct UnresolvedInput<'a> {
    pub kind: Option<haneul_rpc::proto::haneul::rpc::v2::input::InputKind>,
                ...
                .map(|w| {
                    Ok(FundsWithdrawalArg {
                        ...
                        type_arg: WithdrawalTypeArg::Balance(
                            w.coin_type().parse::<haneul_types::TypeTag>().map_err(|e| {
                        ...
                        withdraw_from: match w.source() {
                            haneul_rpc::proto::haneul::rpc::v2::funds_withdrawal::Source::Sender => {
                                WithdrawFrom::Sender
                            }
