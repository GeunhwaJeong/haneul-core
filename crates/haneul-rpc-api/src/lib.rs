    ...
    pub async fn into_router(self) -> axum::Router {
        ...
        let router = {
            ...
            let transaction_execution_service = haneul_rpc::proto::haneul::rpc::v2::transaction_execution_service_server::TransactionExecutionServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let state_service =
                haneul_rpc::proto::haneul::rpc::v2::state_service_server::StateServiceServer::new(
                    self.clone(),
                )
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let signature_verification_service = haneul_rpc::proto::haneul::rpc::v2::signature_verification_service_server::SignatureVerificationServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let move_package_service = haneul_rpc::proto::haneul::rpc::v2::move_package_service_server::MovePackageServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let name_service =
                haneul_rpc::proto::haneul::rpc::v2::name_service_server::NameServiceServer::new(
                    self.clone(),
                )
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
...
haneul_rpc::proto::haneul::rpc::v2::subscription_service_server::SubscriptionServiceServer::new(self.clone());
                health_reporter
                    .set_service_status(
