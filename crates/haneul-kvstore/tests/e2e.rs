...
const TABLES: &[&str] = &[
    haneul_kvstore::tables::objects::NAME,
    ...
    haneul_kvstore::tables::packages_by_id::NAME,
    haneul_kvstore::tables::packages_by_checkpoint::NAME,
    haneul_kvstore::tables::system_packages::NAME,
];
...
async fn get_all_coins(client: &mut GrpcClient, address: HaneulAddress) -> Result<Vec<Object>> {
...
async fn test_indexer_e2e() -> Result<()> {
    ...
    for _ in 0..3 {
        ...
        signed_txns.push(harness.transfer_haneul(recipient, 1).await?);
    }
